...
const development = {
  ...
  DATABASE_HOST: process.env.DEMO_CREDIT_DEV_DATABASE_HOST,
  DATABASE_USER: process.env.DEMO_CREDIT_DEV_DATABASE_USER,
  DATABASE_PASSWORD: process.env.DEMO_CREDIT_DEV_DATABASE_PASSWORD,
  DATABASE_NAME: process.env.DEMO_CREDIT_DEV_DATABASE_NAME,
